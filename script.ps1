...
$Shortcut = (New-Object -ComObject WScript.Shell).CreateShortcut("C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\papq.lnk")
...
Invoke-Item 'C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\papq.lnk'
